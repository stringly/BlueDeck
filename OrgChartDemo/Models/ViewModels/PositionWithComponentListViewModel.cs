...
namespace OrgChartDemo.Models.ViewModels
{
    ...
    public class PositionWithComponentListViewModel
    {
        ...
        /// <summary>
        /// Gets or sets the Id of the Position's parent <see cref="Component"/>
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this Position is designated as the manager of it's parent <see cref="Component"/>.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is unique, or if it can be assigned multiple <see cref="Member"/>s.
        /// </summary>
        /// <value>
        ...
        /// </summary>
        /// <value>
        /// The <see cref="List{T}"/> of <see cref="ComponentSelectListItem"/>s.
        /// </value>
        ...
        /// </summary>
        /// <param name="p">The <see cref="Position"/> being displayed by the view</param>
        /// <param name="l">A <see cref="List{T}"/> of all <see cref="Component"/>s in the repository </param>
        ...
        /// Initializes a new instance of the <see cref="PositionWithComponentListViewModel"/> class.
        /// <remarks>
        /// This parameter-less constructor had to be added in because the <see cref="PositionWithComponentListViewModel.PositionWithComponentListViewModel(Position, List{Component})"/> constructor overrode the default, and the form POST model-binding failed
        /// </remarks>
        /// </summary>
